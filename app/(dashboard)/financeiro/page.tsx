    ...
    return (
        <div className="p-8 max-w-[1600px] mx-auto pb-24">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                <Link href="/financeiro/contas-receber" className="bg-green-50 hover:bg-green-100 border border-green-200 rounded-xl p-4 transition-colors group">
                ...
                <Link href="/financeiro/contas-pagar" className="bg-red-50 hover:bg-red-100 border border-red-200 rounded-xl p-4 transition-colors group">
                ...
                <Link href="/financeiro/fluxo-caixa" className="bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-xl p-4 transition-colors group">
                ...
                <Link href="/financeiro/previsao" className="bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 rounded-xl p-4 transition-colors group">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                <Link href="/financeiro/dre" className="bg-purple-50 hover:bg-purple-100 border border-purple-200 rounded-xl p-4 transition-colors group">
                ...
                <Link href="/financeiro/relatorios" className="bg-orange-50 hover:bg-orange-100 border border-orange-200 rounded-xl p-4 transition-colors group">
